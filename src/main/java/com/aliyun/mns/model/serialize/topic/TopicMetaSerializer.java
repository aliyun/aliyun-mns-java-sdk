...
public class TopicMetaSerializer extends XMLSerializer<TopicMeta> {
    ...
    @Override
    public Map<String, Getter<TopicMeta, Object>> buildGetterMap() {
        return new HashMap<String, Getter<TopicMeta, Object>>() {{
            put(MAX_MESSAGE_SIZE_TAG, TopicMeta::getMaxMessageSize);
            put(LOGGING_ENABLED_TAG, TopicMeta::isLoggingEnabled);
        }};
    }
